  ...
  return (
    <div className="group relative bg-white rounded-xl border border-gray-200 hover:border-gray-300 transition-all duration-300 overflow-hidden hover:shadow-lg">
      <div className="relative">
        ...
        <div className={`absolute top-3 left-3 px-3 py-1 rounded-md text-xs font-medium border ${getCategoryColor(event.category)}`}>
          {event.category}
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-gray-600 text-sm">{event.speaker?.name || 'TBA'}</span>
        </div>
