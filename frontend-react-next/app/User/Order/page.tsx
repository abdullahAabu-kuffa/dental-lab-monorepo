...
const WelcomePage: React.FC<WelcomePageProps> = ({
  ...
  const handleStartOrder = () => { navigateToForm(); onStartOrder?.(); };
  const handleViewOrders = () => { navigateToOrdersList(); onViewOrders?.(); };
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base md:text-lg">Start New Order</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base md:text-lg">View My Orders</span>
                </div>
              ...
              <div className="flex gap-6 sm:gap-8 md:gap-12 justify-start relative">
                ...
                {PROCESS_STEPS.slice(0, 3).map((process, index) => (
                  ...
                  >
                    ...
                    <h4 className="text-xs sm:text-sm md:text-sm font-semibold text-gray-800">{process.title}</h4>
                  </motion.div>
                ))}
              </div>
            </div>
