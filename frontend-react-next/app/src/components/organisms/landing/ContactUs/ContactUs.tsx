...
const ContactSection: React.FC = () => {
		...
		setErrors((prev: any) => {
			...
			switch (field) {
				...
				case "email":
					...
					else if (!emailRegex.test(value)) newErrors.email = "Enter a valid email.";
					else delete newErrors.email;
					break;
				case "phone":
					const phoneRegex = /^[0-9]{8,}$/;
					if (!value.trim()) newErrors.phone = "Phone is required.";
					else if (!phoneRegex.test(value)) newErrors.phone = "Phone must be numbers only ";
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		const isValid = Object.values(form).every(val => val.trim() !== "") && Object.keys(errors).length === 0;
		if (isValid) {
			setSubmitted(true);
			...
			<div className="max-w-7xl mx-auto px-6">
				<div className="grid lg:grid-cols-2 gap-16">
					<ScrollAnimation variant="fadeInFromLeft">
						<HeroHeading primaryText="" gradientText="Get In Touch" variant="black"/>
						<HeroSubtitle
						...
						<form className="space-y-6" onSubmit={handleSubmit}>
							...
							<div>
								...
								<input
									...
									className={`w-full px-4 py-3 rounded-lg border ${errors.name ? "border-red-500" : "border-gray-300"} focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 outline-none transition`}
							...
							<div>
								...
								<input
									...
									className={`w-full px-4 py-3 rounded-lg border ${errors.email ? "border-red-500" : "border-gray-300"} focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 outline-none transition`}
							...
							<div>
								...
								<input
									...
									className={`w-full px-4 py-3 rounded-lg border ${errors.phone ? "border-red-500" : "border-gray-300"} focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 outline-none transition`}
							...
							<div>
								...
								<textarea
									...
									className={`w-full px-4 py-3 rounded-lg border ${errors.message ? "border-red-500" : "border-gray-300"} focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/20 outline-none transition resize-none`}
