    ...
    <section className="relative min-h-screen bg-gradient-to-br from-[#151821] via-[#1a1d2e] to-[#252938] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.015]">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="tooth-pattern" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
              <path d="M100,40 Q90,60 100,80 Q110,60 100,40 M80,100 L90,120 L100,110 L110,120 L120,100" 
