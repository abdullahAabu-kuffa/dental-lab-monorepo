						...
						<div className="space-y-8">
							...
							>
								...
								<p className="text-base md:text-lg text-gray-700 leading-relaxed font-light">
									...
									combining expert craftsmanship with cutting-edge digital
									technologies. Our team uses ExoCAD and CAD/CAM systems to
									deliver flawless dental restorations with unmatched precision
									and speed.
								</p>
							</motion.div>
							...
							>
								...
								<p className="text-base md:text-lg text-gray-700 leading-relaxed font-light">
									Our digital workflow allows you to easily choose services and
									materials and track every stage of your case online —
							...
							>
								...
								<p className="text-base md:text-lg text-gray-700 leading-relaxed font-light">
									We offer guides, workshops, and tutorials on ExoCAD best
									practices, digital implant planning, and material selection —
									helping dental professionals stay ahead.
								</p>
							</motion.div>
						</div>
					</motion.div>
