  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-200">
        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-linear-to-r from-[#E4B441] to-[#D4A431] rounded-full flex items-center justify-center shrink-0">
          {icon}
        </div>
        ...
        {selectedItems.length === 0 ? (
          ...
          selectedItems.map((item, index) => (
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-semibold text-[#E4B441] shrink-0">
                ${item.price}
              </span>
            </div>
          ))
      ...
      {/* Total Section */}
      <div className="bg-linear-to-r from-[#E4B441]/10 to-[#D4A431]/10 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
      ...
      {/* <motion.button
        ...
        className={`w-full py-3 sm:py-4 px-4 sm:px-6 rounded-lg font-semibold text-sm sm:text-base lg:text-lg flex items-center justify-center gap-2 sm:gap-3 transition-all ${
          isDisabled
            ...
            : "bg-linear-to-r from-[#E4B441] to-[#D4A431] text-white hover:from-[#FFD700] hover:to-[#E4B441] shadow-lg hover:shadow-xl"
        }`}
      >
