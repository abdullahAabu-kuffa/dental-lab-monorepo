						...
						<div className="prose max-w-none">
							{resource.id === "1" && (
								<div>
									...
									<p className="mb-4">
										Dental emergencies can happen at any time, and knowing how
										to respond quickly can make the difference between saving
										and losing a tooth.
									</p>
									...
									<ul className="list-disc list-inside space-y-1 mb-4">
										<li>
											<strong>Knocked-out tooth:</strong> Handle by the crown,
											rinse gently, and try to reinsert
										</li>
										<li>
											<strong>Severe toothache:</strong> Rinse with warm water
											and apply cold compress
										</li>
										<li>
											<strong>Broken tooth:</strong> Save any pieces and rinse
											your mouth with warm water
										</li>
									</ul>
									<p className="text-sm text-gray-500">
										Remember: Time is crucial in dental emergencies. Contact
							...
							{resource.id === "2" && (
								<div>
									...
									<p className="mb-4">
										Dental implants are titanium posts surgically placed into
										your jawbone to replace missing tooth roots.
									</p>
									<h5 className="font-semibold mb-2">
							...
							{resource.id === "3" && (
								<div>
									...
									<p className="mb-4">
										...
										brighten your smile several shades in just one visit.
									</p>
									...
									<ul className="list-disc list-inside space-y-1 mb-4">
										...
										<li>
											Application of whitening gel and activation with special
											light
										</li>
										<li>Multiple applications for optimal results</li>
									</ul>
									<p className="text-sm">
										Results can last 1-3 years with proper oral hygiene and
							...
							{(resource.id === "4" || resource.id === "8") && (
								<div>
									...
									<p className="mb-4">
										Modern cosmetic dentistry offers numerous options to enhance
										your smile and boost your confidence.
									</p>
									<h5 className="font-semibold mb-2">Popular Treatments:</h5>
									<ul className="list-disc list-inside space-y-1 mb-4">
										<li>
											<strong>Veneers:</strong> Thin shells that cover the front
											of teeth
										</li>
										<li>
											<strong>Bonding:</strong> Tooth-colored resin to repair
											chips and gaps
										</li>
										<li>
											<strong>Contouring:</strong> Reshaping teeth for better
											appearance
										</li>
										<li>
											<strong>Whitening:</strong> Brightening discolored teeth
										</li>
									</ul>
									<p className="text-sm">
										Your cosmetic dentist will recommend the best treatment
							...
							{resource.id === "5" && (
								<div>
									...
									<p className="mb-4">
										Tooth sensitivity affects millions of people and can make
									...
									<p className="text-sm">
										Desensitizing toothpaste, fluoride treatments, dental
										bonding, or gum grafts depending on the severity.
									</p>
								</div>
							)}
							...
							{(resource.id === "6" || resource.id === "9") && (
								<div>
									...
									<p className="mb-4">
										...
										optimal oral health and preventing serious problems.
									</p>
									<h5 className="font-semibold mb-2">
									...
									<p className="text-sm">
										Most people should visit the dentist every 6 months, though
										some may need more frequent visits.
									</p>
								</div>
							)}
							...
							{resource.id === "7" && (
								<div>
									...
									<p className="mb-4">
										...
										offering a permanent solution that looks, feels, and
										functions like natural teeth.
									</p>
									<h5 className="font-semibold mb-2">Implant Components:</h5>
									<ul className="list-disc list-inside space-y-1 mb-4">
										<li>
											<strong>Implant fixture:</strong> The titanium post placed
											in the jawbone
										</li>
										<li>
											<strong>Abutment:</strong> The connector piece
										</li>
										<li>
											<strong>Crown:</strong> The visible tooth replacement
										</li>
									</ul>
									<h5 className="font-semibold mb-2">Who Can Get Implants:</h5>
									<p className="text-sm">
										Most adults with good oral and general health are
										candidates. Your dentist will evaluate bone density and
										overall health.
									</p>
								</div>
							)}
							...
							{!["1", "2", "3", "4", "5", "6", "7", "8", "9"].includes(
								...
								<div>
									...
									<p>
										This comprehensive guide covers important aspects of dental
										health and treatment options. For personalized advice and
										treatment, consult with your dental professional.
									</p>
								</div>
							)}
						</div>
