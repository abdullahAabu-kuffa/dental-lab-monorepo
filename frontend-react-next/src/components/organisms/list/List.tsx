      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 text-right">
          <div className="flex items-center gap-3 flex-row-reverse">
            <ProfileIcon size="lg" username={user?.data.user.fullName || username} />
        ...
        <div className="py-2 flex flex-col divide-y divide-gray-200">
          {[
            { name: "My Orders", icon: Package, link: "/User/Order/orders-list", type: "order" },
            ...
            { name: "Events", icon: Calendar, link: "/User/Order/Event", type: "event" },
            ...
            <Link
              ...
              className="w-full px-4 py-3 flex items-center gap-3 flex-row-reverse text-gray-700 transition-all duration-200 rounded-lg hover:bg-linear-to-r hover:from-yellow-100 hover:to-yellow-50 hover:scale-105"
            >
          ...
          <button
            ...
            className="w-full px-4 py-3 flex items-center gap-3 flex-row-reverse text-red-600 transition-all duration-200 rounded-lg hover:bg-red-50 hover:scale-105 font-medium"
          >
            <span>Logout</span>
          </button>
        </div>
  ...
  return (
    <div className="relative" ref={menuRef} dir="rtl">
      <button
        ...
        "
      >
        <ProfileIcon size="md" username={user?.data.user.fullName || username} />
        <ChevronDown
      ...
      {isOpen && (
        <DropdownMenu
          username={user?.data.user.fullName || username}
          email={email}
          onLogout={onLogout}
