...
import {
	...
	SERVICES_LINKS,
	CONTACT_INFO,
} from "../../../config/LandingData/contact.data";
			...
			<div className="max-w-7xl mx-auto px-6 py-8 flex flex-col gap-8">
				<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center sm:text-left">
					...
					<div className="flex flex-col items-center sm:items-start">
						...
						<p className="text-sm leading-relaxed text-gray-300 mt-2">
							Egypt&apos;s first fully digital dental laboratory,
							revolutionizing dental restoration.
						</p>
					</div>
				...
				<div className="border-t border-gray-700 pt-4">
					<p className="text-center text-sm text-gray-400">
						&copy; {currentYear} Avanté Dental Lab. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
